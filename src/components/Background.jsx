    ...
    <div className="fixed inset-0 z-10 pointer-events-none overflow-hidden" aria-hidden="true">
      ...
      >
        ...
        <g stroke="#FAFAFA" fill="none" strokeLinecap="round" strokeLinejoin="round">
          <path d="M0 60 H 60 L 110 110 V 170" strokeWidth="1.5" opacity="0.58" />
          <path d="M0 110 H 50 L 100 160 V 230 L 140 270" strokeWidth="1" opacity="0.65" />
        ...
        <g stroke="#FAFAFA" fill="none" strokeLinecap="round" strokeLinejoin="round">
          <path d="M1440 50 H 1360 L 1310 100 V 160" strokeWidth="1.5" opacity="0.58" />
          <path d="M1440 100 H 1370 L 1320 150 V 220 L 1280 260" strokeWidth="1" opacity="0.65" />
        ...
        <g stroke="#FAFAFA" fill="none" strokeLinecap="round" strokeLinejoin="round">
          <path d="M0 840 V 780 L 50 730 H 110" strokeWidth="1.5" opacity="0.58" />
          <path d="M0 880 V 820 L 60 760 H 140 L 190 710" strokeWidth="1" opacity="0.65" />
          ...
          <path d="M240 900 V 870 L 290 820 H 360 L 410 770" strokeWidth="0.8" opacity="0.80" />
        </g>

        {/* ── Bottom-right corner cluster ── */}
        <g stroke="#FAFAFA" fill="none" strokeLinecap="round" strokeLinejoin="round">
          <path d="M1440 830 H 1350 L 1300 780 V 720" strokeWidth="1.5" opacity="0.58" />
          <path d="M1440 870 H 1360 L 1310 820 V 750 L 1270 710" strokeWidth="1" opacity="0.65" />
          ...
          <path d="M1200 900 H 1120 L 1070 850 V 800 L 1030 760" strokeWidth="0.8" opacity="0.50" />
        </g>

        {/* ── Left edge vertical bus ── */}
        <g stroke="#FAFAFA" fill="none" strokeLinecap="round" strokeLinejoin="round">
          <path d="M25 0 V 250 L 65 290 V 450 L 105 490 V 650 L 65 690 V 900" strokeWidth="1" opacity="0.82" />
          <path d="M50 0 V 200 L 90 240 V 400 L 130 440 V 580" strokeWidth="0.8" opacity="0.88" />
          <path d="M75 0 V 150 L 115 190 V 340" strokeWidth="0.6" opacity="0.20" />
          <path d="M100 0 V 100 L 140 140 V 280 L 170 310 V 450" strokeWidth="0.5" opacity="0.82" />
        </g>

        {/* ── Right edge vertical bus ── */}
        <g stroke="#FAFAFA" fill="none" strokeLinecap="round" strokeLinejoin="round">
          <path d="M1415 0 V 260 L 1375 300 V 460 L 1335 500 V 660 L 1375 700 V 900" strokeWidth="1" opacity="0.82" />
          <path d="M1390 0 V 210 L 1350 250 V 410 L 1310 450 V 590" strokeWidth="0.8" opacity="0.88" />
          <path d="M1365 0 V 160 L 1325 200 V 350" strokeWidth="0.6" opacity="0.80" />
          <path d="M1340 0 V 110 L 1300 150 V 290 L 1270 320 V 460" strokeWidth="0.5" opacity="0.82" />
        </g>

        {/* ── Bottom horizontal traces ── */}
        <g stroke="#FAFAFA" fill="none" strokeLinecap="round" strokeLinejoin="round">
          <path d="M300 900 V 860 L 350 810 H 480 L 530 760 V 700" strokeWidth="0.8" opacity="0.82" />
          <path d="M550 900 V 870 L 600 820 H 720 L 770 770 V 710" strokeWidth="0.6" opacity="0.80" />
          <path d="M800 900 V 850 L 750 800 H 650" strokeWidth="0.7" opacity="0.82" />
          <path d="M950 900 V 880 L 900 830 H 830" strokeWidth="0.5" opacity="0.80" />
          <path d="M1050 900 V 860 L 1000 810 H 930 L 880 760" strokeWidth="0.6" opacity="0.82" />
        </g>

        {/* ── Top horizontal traces ── */}
        <g stroke="#FAFAFA" fill="none" strokeLinecap="round" strokeLinejoin="round">
          <path d="M200 0 V 50 L 250 100 H 380 L 430 150 V 210" strokeWidth="0.8" opacity="0.82" />
          <path d="M450 0 V 40 L 500 90 H 620 L 670 140 V 190" strokeWidth="0.6" opacity="0.80" />
          <path d="M700 0 V 60 L 650 110 H 550" strokeWidth="0.7" opacity="0.82" />
          <path d="M900 0 V 30 L 850 80 H 780" strokeWidth="0.5" opacity="0.80" />
        </g>

        {/* ── Diagonal cross-connects (edge to edge) ── */}
        <g stroke="#FAFAFA" fill="none" strokeLinecap="round" strokeLinejoin="round" opacity="0.80">
        ...
        <g stroke="#FAFAFA" fill="none" strokeWidth="0.8" opacity="0.85">
        ...
        <g stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round" opacity="0.7">
